...
class VehicleUserPage extends StatefulWidget {
  ...
  const VehicleUserPage({Key key, this.username, this.favorites = false, this.fabHeroSuffix}) : super(key: key);
  @override
    ...
    return Stack(
      children: <Widget>[
        ...
        buildSingularDataPage(
          ...
          data: data,
          isLoading: isLoading,
          builder: (context, data) => VehicleList(vehicle: data, vehicleHeroPrefix: 'vehicle_user_page',),
        ),
        Align(
          ...
          child: Padding(
            ...
            child: Visibility(
              ...
              child: FloatingActionButton(
                heroTag: 'vehicle_user_page_fab_${math.Random().nextInt(325912321)}',
